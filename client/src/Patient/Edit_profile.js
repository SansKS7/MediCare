                                ...
                                <div className="card card1 mb-3">
                                    <div className="card-body">
                                        <div className="row">
                                            ...
                                            <label for="disabledTextInput" class="form-label"> <h6 className="mb-0">Patient-ID</h6> </label>
                                        ...
                                        <div className="row">
                                            ...
                                            <label for="disabledTextInput" class="form-label"> <h6 className="mb-0">LastName</h6></label>
                                        ...
                                        <div className="row">
                                            ...
                                            <label for="disabledTextInput" class="form-label"><h6 className="mb-0">Age</h6></label>
